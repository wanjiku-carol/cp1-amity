...
class MyInteractive (cmd.Cmd):
    ...
    def do_create_room(self, args):
        ...
        print(Amity().create_room(room_type, args["<room_name>"]))

    @docopt_cmd
    def do_add_person(self, args):
        """Usage: add_person <first_name> <last_name>
        (Fellow|Staff) [wants_accommodation]"""
        if args["Staff"]:
            designation = "Staff"
        else:
            designation = "Fellow"
        ...
        print(Amity().add_person(first_name, last_name, designation, wants_accommodation))

    # @docopt_cmd
    # def do_reallocate_office(self, args):
    #     """Usage: reallocate_person <person_identifier> <new_room_name>"""
    #
    #     print(Amity().reallocate_office(args))
    #
    # @docopt_cmd
